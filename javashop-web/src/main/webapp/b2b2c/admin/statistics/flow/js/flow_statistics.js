...
function initFlowStatistics(dateWhere) {
	...
	// ajax配置
	var options = {
		url : ctx + "/b2b2c/admin/flowStatistics/get-flow-statistics.do" ,
		data : {'start_date' : dateWhere[0], 'end_date' : dateWhere[1],'statistics_type':dateWhere[2],'store_id':store_id},
		type : "post",
		dataType:"json",
