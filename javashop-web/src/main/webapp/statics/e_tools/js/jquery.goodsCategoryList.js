...
;(function ($, window, document, undefined) {
    ...
    goodsCatsEdit.prototype = {
        ...
        searchCat: function ($this) {
            ...
            if (!_this.params.catDatas[_leave - 1][0]) {
                alert('无匹配项！');
            }else {
        ...
        appendContent: function (count, _val) {
            ...
            var _itemBtns = _this.options.itemBtns;
            var _item = '';
            ...
            var content = '<div class="__GCD__column">\
                    <div class="__GCD__item">\
                        <div class="__GCD__content">\
                            <div class="__GCD__input"><input value="' + (typeof(_val) === 'string' ? _val : '') + '" class="__GCD__input_input" placeholder="输入名称查找" data-leave="' + __l + '"><i class="__search __icon" data-leave="' + __l + '"></i></div>\
        ...
        createLinkEle: function () {
            $('#goodsCatsEditCss').length === 0 && (function () {
                ...
                styleEle.href = ctx + '/statics/e_tools/js/jquery.goodsCategoryList.css';
