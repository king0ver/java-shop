 ...
 * javashop网关 
 */
JavashopProxy.gateway = function (url) {

    return ""
    // return "http://192.168.1.178:5555/api";
    //return  "http://gateway.bigdata.javamall.com.cn:5555/api";
...
//         };
//         var options = $.extend({}, defaults, opt);
//         if (options.url === "/datatables/zh_CN.txt") {
//             options.proxy = false;
//         }
//         if (options.proxy) {

//             var gateway = self.gateway(options.url);
//             if (options.url.indexOf(gateway) < 0) {
//                 options.url = gateway + options.url;
//             }
//         }
