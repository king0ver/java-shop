...
import com.enation.eop.processor.facade.ImageThumbnaiProcessor;
...
public class DispatcherFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		try {
			...
			/** 如果访问的是/statics/attachment路径下得图片 */
			if(uri.startsWith("/statics/attachment")) {
				eopProcessor=new ImageThumbnaiProcessor();
			...
			// 前台处理器	2017-9-1 添加过滤swagger by Sylow
