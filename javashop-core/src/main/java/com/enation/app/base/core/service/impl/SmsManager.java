...
public class SmsManager implements ISmsManager {
	 ...
	 * 
	 * @see
	 * com.enation.app.base.core.service.ISmsManager#addSmsPlatform(com.enation.
	 * app.base.core.model.SmsPlatform)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.enation.app.base.core.service.ISmsManager#getSmsPlatformHtml(java.
	 ...
	 * 
	 * @see
	 * com.enation.app.base.core.service.ISmsManager#setParam(java.lang.Integer,
	 * java.util.Map)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.enation.app.base.core.service.ISmsManager#open(java.lang.Integer)
	 */
	@Override
	...
	@Override
	public SmsPlatform getOpen() {
		String sql ="select * from es_sms_platform where is_open = ?";
		return this.daoSupport.queryForObject(sql, SmsPlatform.class,1);
	}
}
