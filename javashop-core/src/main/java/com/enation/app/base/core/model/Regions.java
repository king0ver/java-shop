...
public class Regions implements java.io.Serializable{
	...
	public RegionVo toVo() {
		...
		vo.setLocal_name(this.getLocal_name());
		vo.setP_regions_id(this.getP_region_id());
		vo.setRegion_id(this.getRegion_id());
		vo.setRegionVos(new ArrayList<RegionVo>());
		vo.setLevel(this.getRegion_grade());
		return vo;
	}
