...
public class RegionApiController {
	...
	@ResponseBody
	@RequestMapping("/get")
	public String getRegionsByDepth(int depth) {
		return regionsManager.getRegions(depth);
	}

	@ResponseBody
	@RequestMapping("/get-childrens")
	public String getChildrenById(int region_id) {
		return regionsManager.getRegionsChildren(region_id);
	}
}
