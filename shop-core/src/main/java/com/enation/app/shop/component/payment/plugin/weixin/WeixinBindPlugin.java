...
import com.enation.app.shop.member.plugin.IMemberLoginEvent;
import com.enation.app.shop.member.plugin.IMemberRegisterEvent;
...
//						LOGGER.debug("跳转出错:", e);
//					}
//					this.daoSupport.execute("update es_member set wechat_id=? where member_id=?", unionId, memberId);
//				}
//				
