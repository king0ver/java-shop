...
import com.enation.app.shop.statistics.service.IGoodsStatisticsManager;
...
public class GoodsStatisticsManager  implements IGoodsStatisticsManager {
	...
	public Page getgoodsSalesDetail(long startTime, long endTime, int page,
		...
		if(catid==null || catid.intValue()==0){
			...
			cat_path = this.daoSupport.queryForString("select gc.catcategory_path from es_goods_category gc where gc.category_id="+catid);
		}
