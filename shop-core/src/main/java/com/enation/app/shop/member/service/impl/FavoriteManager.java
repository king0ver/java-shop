...
public class FavoriteManager implements IFavoriteManager {
	...
	@Override
	public void delete(Integer goods_id, Integer member_id) {
		this.daoSupport.execute("delete from es_favorite where goods_id = ? and member_id = ? ", goods_id,member_id);
